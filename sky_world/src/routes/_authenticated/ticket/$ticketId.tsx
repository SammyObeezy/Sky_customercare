  ...
  if (!ticket) {
    return (
      <div className="ticket-not-found">
        ...
        <Link to="/ticket-list" search={{}} className="back-link">
      ...
      <div className="ticket-details-page">
        <div className="page-header-section">
          <div className="page-header-content">
            ...
            <p className="ticket-subject-header">Subject: {editedData.ticketSubject || ticket.ticketSubject}</p>
          </div>
        ...
        <div className="ticket-content-grid">
          ...
          <div className="ticket-form-section">
            {isEditing ? (
                  ...
                  <div className="form-group description-group">
                    ...
                    <div className="editor-toolbar">
                      <div className="toolbar-group">
                        <button type="button" className="toolbar-btn" title="Bold" onClick={() => applyFormatting('bold')}>
                      ...
                      <div className="toolbar-group">
                        <button type="button" className="toolbar-btn" title="Heading 1" onClick={() => applyFormatting('heading1')}>
                      ...
                      <div className="toolbar-group">
                        <button type="button" className="toolbar-btn" title="Bullet List" onClick={() => applyFormatting('bulletList')}>
                          <BulletListIcon width={16} height={16} />
                        </button>
                        <button type="button" className="toolbar-btn" title="Numbered List" onClick={() => applyFormatting('numberedList')}>
                          <NumberedListIcon width={16} height={16} />
                        </button>
                      </div>

                      <div className="toolbar-group">
                        <button type="button" className="toolbar-btn" title="Link" onClick={() => applyFormatting('link')}>
                          <LinkIcon width={16} height={16} />
                        </button>
                        <button type="button" className="toolbar-btn" title="Quote" onClick={() => applyFormatting('quote')}>
                          <QuoteIcon width={16} height={16} />
                        </button>
                        <button type="button" className="toolbar-btn" title="Code" onClick={() => applyFormatting('code')}>
              ...
              <div className="ticket-form-display">
                <div className="display-header">
                  <h3>Ticket Information</h3>
                  <button onClick={() => setIsEditing(true)} className="edit-btn">Edit Ticket</button>
                </div>
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    <label>Status</label>
                    <span className={`status-badge status-${ticket.ticketStatus.toLowerCase().replace(' ', '-')}`}>
                      {ticket.ticketStatus}
                    </span>
                  </div>
                  <div className="info-item">
              ...
              {ticket.attachments && ticket.attachments.length > 0 ? (
                <div className="attachments-section">
                  <div className="attachments-header">
                    <span className="attachment-count">{ticket.attachments.length} file(s) attached</span>
                  </div>
                    ...
                    {ticket.attachments.map(file => (
                      <div key={file.id} className="attachment-item">
                        ...
                        <div className="attachment-actions">
                          ...
                          {isEditing && (
                            <button className="remove-btn" title="Remove attachment">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
